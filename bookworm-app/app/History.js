...
import {  ReadBooks, threeHistoryList } from "./config.js";
...
export class HistoryPage extends React.Component {
  ...
  render() {
    return (
      ...
      ListHeaderComponent={() => (
        <Text style={{ fontSize: 20, textAlign: "center",marginTop:20, padding: 20, fontWeight:'bold',textDecorationLine: 'underline' }}>
          3 Last Read Books
        </Text>
      )}
      ListFooterComponent={() => (
